...
typedef enum {
    ...
    BWD_DATA_INDEX  			= 3,
    BWD_FILTER_INDEX  			= 4,
    CONVERT_FORWARD_INPUT 		= 5,
    CONVERT_FORWARD_FILTER        	= 6,
    CONVERT_FORWARD_BIAS     		= 7,
    CONVERT_FORWARD_OUTPUT   		= 8,
    CONVERT_BWDDATA_INPUT 		= 9,
    CONVERT_BWDDATA_FILTER        	= 10,
    CONVERT_BWDDATA_OUTPUT   		= 11,
    CONVERT_BWDFILTER_INPUT 		= 12,
    CONVERT_BWDFILTER_FILTER        	= 13,
    CONVERT_BWDFILTER_OUTPUT   		= 14,
    BUFFER_FORWARD_INPUT 		= 15,
    BUFFER_FORWARD_FILTER        	= 16,
    BUFFER_FORWARD_BIAS     		= 17,
    BUFFER_FORWARD_OUTPUT   		= 18,
    BUFFER_BWDDATA_INPUT 		= 19,
    BUFFER_BWDDATA_FILTER        	= 20,
    BUFFER_BWDDATA_OUTPUT   		= 21,
    BUFFER_BWDFILTER_INPUT 		= 22,
    BUFFER_BWDFILTER_FILTER        	= 23,
    BUFFER_BWDFILTER_OUTPUT   		= 24
