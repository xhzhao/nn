...
typedef enum {
    ...
    BWD_DATA_INDEX  			= 7,
    BWD_FILTER_INDEX  			= 8,
    CONVERT_FORWARD_INPUT 		= 9,
    CONVERT_FORWARD_FILTER        	= 10,
    CONVERT_FORWARD_BIAS     		= 11,
    CONVERT_FORWARD_OUTPUT   		= 12,
    CONVERT_BWDDATA_INPUT 		= 13,
    CONVERT_BWDDATA_FILTER        	= 14,
    CONVERT_BWDDATA_OUTPUT   		= 15,
    CONVERT_BWDFILTER_INPUT 		= 16,
    CONVERT_BWDFILTER_FILTER        	= 17,
    CONVERT_BWDFILTER_OUTPUT   		= 18,
    BUFFER_FORWARD_INPUT 		= 19,
    BUFFER_FORWARD_FILTER        	= 20,
    BUFFER_FORWARD_BIAS     		= 21,
    BUFFER_FORWARD_OUTPUT   		= 22,
    BUFFER_BWDDATA_INPUT 		= 23,
    BUFFER_BWDDATA_FILTER        	= 24,
    BUFFER_BWDDATA_OUTPUT   		= 25,
    BUFFER_BWDFILTER_INPUT 		= 26,
    BUFFER_BWDFILTER_FILTER        	= 27,
    BUFFER_BWDFILTER_OUTPUT   		= 28
...
typedef enum {
    ...
    BUFFER_BN_BACKWARD_WORKSPACE       	= 9,
    BUFFER_BN_BACKWARD_SCALESHIFT      	= 10,
    CV_BN_BACKWARD_OUTPUT		= 11,
    BUFFER_BN_BACKWARD_OUTPUT		= 12
} mkldnnBNIndex_t;
