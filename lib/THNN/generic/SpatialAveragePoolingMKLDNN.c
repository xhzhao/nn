...
static void THNN_(SpatialAveragePooling_MKLDNN_init_forward)(
...
static void THNN_(SpatialAveragePooling_MKLDNN_init_backward)(
          THLongTensor *primitives,
          int N,
          int inC,
          int inH,
...
/**************************************MKLDNN interface*****************************************/
	...
	if(initOk == 0)
	{
		...
		THNN_(SpatialAveragePooling_MKLDNN_init_forward)(primitives,N,inC,inH,inW,kH,kW,dH,dW,padH,padW,outC,outH,outW);
	}
...
/**************************************MKLDNN interface*****************************************/
	...
	if(initOk == 0)
	{
		...
		THNN_(SpatialAveragePooling_MKLDNN_init_backward)(primitives,N,inC,inH,inW,kH,kW,dH,dW,padH,padW,outC,outH,outW);
	}
